...
$siswa = mysqli_fetch_assoc(mysqli_query($conn, "SELECT COUNT(*) AS total_item FROM users WHERE role_user = 'Siswa'"));
$guru = mysqli_fetch_assoc(mysqli_query($conn, "SELECT COUNT(*) AS total_item FROM users WHERE role_user = 'Guru'"));
